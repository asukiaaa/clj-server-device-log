...
(defn device-type-config-on-user-team [] (get-word-from-words :device-type-config-on-user-team))
...
(defn login-and-show-this-page [] (get-word-from-words :login-and-show-this-page))
...
(defn member [] (get-word-from-words :member))
...
(defn password-edit [] (get-word-from-words :password-edit))
(defn permission [] (get-word-from-words :permission))
(def prev "Prev")
...
(defn updated-at [] (get-word-from-words :updated-at))
(defn user-item [user] (show-key user [:name :email :id]))
(defn user [] (get-word-from-words :user))
...
(defn value [] (get-word-from-words :value))
