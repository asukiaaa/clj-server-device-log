...
(defn render-watch-scope [watch-scope]
  [:tr
   ...
   [:td (util.watch-scope/render-terms-with-device (:terms watch-scope))]
   [:td
    (util/render-list-inline
     (v.watch-scope.util/build-related-links watch-scope))]])

(def labels-header [(util.label/name) (util.label/user-team) (util.label/term) (util.label/action)])
